...
- **Google Gemini Integration** — Uses `gemini-1.5-flash` to intelligently parse user responses, validate inputs, and generate structured updates to the LLP agreement.
