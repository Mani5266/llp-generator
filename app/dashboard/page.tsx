        ...
        {agreements.length === 0 ? (
          ...
          <div className="dash-empty animate-slideUp">
            <div className="dash-empty-icon">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#0f1a2e" strokeWidth="1.5" strokeLinecap="round">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                <polyline points="14 2 14 8 20 8" />
                  ...
                  <div className="dash-card-header">
                    <div className={`dash-card-icon ${a.is_done ? "dash-card-icon-done" : ""}`}>
                      {a.is_done ? (
                        ...
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#0f1a2e" strokeWidth="2">
                          <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                          <polyline points="14,2 14,8 20,8" />
                        </svg>
                      )}
                  ...
                  <div className="dash-progress-row">
                    <div className="dash-progress-track">
                      <div
                        ...
                        style={{ width: `${pct}%`, background: pct === 100 ? "#f0b929" : "#0f1a2e" }}
                      />
                    </div>
                    <span className="dash-progress-pct" style={{ color: pct === 100 ? "#f0b929" : "#0f1a2e" }}>
                      {pct}%
                    </span>
                  </div>
